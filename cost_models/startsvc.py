...
def post_cvs(data_new):
    with open('/home/apple/code/project1/tune/cost_models/store1.csv', 'w', encoding='utf-8') as f:
...
def get_ff():
    return open('/home/apple/code/project1/tune/cost_models/store1.csv', '+')
...
colors_list = ['Альпийский зеленый', 'Сияющая звезда', 'Синий', 'Тёмная ночь', 'Чёрный', 'Небесно-голубой',
...
colors_dict = {'Альпийский зеленый': 'alpine green',
               'Синий': 'Blue',
               'Розовый': 'Pink',
               'Тёмная ночь': 'Black',
               'Чёрный': 'Black',
