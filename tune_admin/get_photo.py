...
def get_photo(series):
    ...
    if 'iphone' in name:
        ...
        if 'iphone13pro' in name and 'mini' not in name:
            return path_to_iphone + 'iphone/iphone_13_pro.jpg'
        ...
        if 'iphone12pro' in name and 'mini' not in name:
            return path_to_iphone + 'iphone/iphone_12_pro.jpg'
