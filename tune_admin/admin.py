...
class PostAdmin(admin.ModelAdmin):
    form = AddressForm
    list_display = ['name', 'price', 'article', 'category', 'series', 'sale', 'moderation', 'booking', 'sell', 'author',
                    'day_created', ]
    ...
    #         queryset = queryset.filter(device=1)
    #     print(11)
    #     return queryset

    # class Media:
    #     js = (
    #         'C:\\Users\\lindel\\Py_Projects\\newTune\\chained-area.js',
    #     )
