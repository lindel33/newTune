# Generated by Django 3.2.12 on 2022-04-30 20:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('guaranty', models.CharField(max_length=255, verbose_name='Текст')),
                ('guaranty_id', models.CharField(max_length=255, verbose_name='Текст')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kit', models.CharField(max_length=255, verbose_name='Текст')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation', models.BooleanField(default=True, verbose_name='Допущен к публикации?')),
                ...
                ('name_tmp', models.CharField(max_length=100, verbose_name='Фоновое имя')),
                ...
                ('device_provider', models.BooleanField(default=False, verbose_name='Устройство поставщика')),
                ('www', models.BooleanField(default=True, verbose_name='Первичное SMT')),
                ...
                ('guaranty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tune_admin.guarantymodel', verbose_name='Гарантия')),
                ('kit', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='tune_admin.kitmodel', verbose_name='Комплект')),
